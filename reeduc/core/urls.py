...
urlpatterns = [
    ...
    path("cadastro/setor-juridico/<int:cadastro_id>", views.cadastro_setor_juridico_view, name="cadastro-setor-juridico"),
    path("cadastro/setor-juridico/<int:cadastro_id>/<int:registro_id>/ver", views.cadastro_setor_juridico_ver_view, name="cadastro-setor-juridico-ver"),
    path("cadastro/setor-juridico/<int:cadastro_id>/<int:registro_id>/editar", views.cadastro_setor_juridico_editar_view, name="cadastro-setor-juridico-editar"),
    path("cadastro/setor-juridico/<int:cadastro_id>/<int:registro_id>/excluir", views.cadastro_setor_juridico_excluir_view, name="cadastro-setor-juridico-excluir"),
    ...
    path("familiares", views.familiares_avulsos_lista_view, name="familiares-avulsos-lista"),
    path("familiares/adicionar", views.familiar_avulso_adicionar_view, name="familiar-avulso-adicionar"),
    path("familiares/<int:familiar_id>/ver", views.familiar_avulso_ver_view, name="familiar-avulso-ver"),
    path("familiares/<int:familiar_id>/setor-juridico", views.familiar_avulso_setor_juridico_view, name="familiar-avulso-setor-juridico"),
    path("familiares/<int:familiar_id>/setor-juridico/<int:registro_id>/ver", views.familiar_avulso_setor_juridico_ver_view, name="familiar-avulso-setor-juridico-ver"),
    path("familiares/<int:familiar_id>/setor-juridico/<int:registro_id>/editar", views.familiar_avulso_setor_juridico_editar_view, name="familiar-avulso-setor-juridico-editar"),
    path("familiares/<int:familiar_id>/setor-juridico/<int:registro_id>/excluir", views.familiar_avulso_setor_juridico_excluir_view, name="familiar-avulso-setor-juridico-excluir"),
    path("familiares/<int:familiar_id>/editar", views.familiar_avulso_editar_view, name="familiar-avulso-editar"),
    path("familiares/<int:familiar_id>/excluir", views.familiar_avulso_excluir_view, name="familiar-avulso-excluir"),
